...
def get_volumen(currency1, currency2):
    ...
    return sum([float(response['items'][i]['wypadly_teraz_i_w_pieciu_poprz']) for i in range(len(response['items']))])
...
def plotting_graph(_):
    ...
    plt.plot(t, values_1_bid, 'nie_padly_w_5_loso-', label="bid")
    ...
    # plt.set_xticks(xLabels)#################################################### TUTAJ UWAŻAJ
    ...
    plt.plot(t, values_2_bid, 'nie_padly_w_5_loso-', label="bid")
    ...
    plt.plot(t, values_3_bid, 'nie_padly_w_5_loso-', label="bid")
    ...
    plt.plot(t, rsi_values_1_bid, 'nie_padly_w_5_loso-', label="rsi_bid")
    ...
    plt.plot(t, rsi_values_2_bid, 'nie_padly_w_5_loso-', label="rsi_bid")
    ...
    plt.plot(t, rsi_values_3_bid, 'nie_padly_w_5_loso-', label="rsi_bid")
...
if __name__ == '__main__':
    ...
    Y = 3
    S = 8
    AB = 'A'  # ciag(input('if you want to classify the RSI indicator for ask write A, if for bid write B: '))
    INTERVAL = 3
