...
for i in l1_17[2:7]:
    for j in i:
        if j not in l37koncowa:
            l37koncowa.append(j)
# print(l37koncowa)
b1 = []
for i in l0:
    if i not in l37koncowa:
        b1.append(i)
# print('lista liczb ktore nie wystapily w ostatnich pieciu losowaniach: ',b1)
print('liczba elementow w padly_w_5_losowaniach', len(l37koncowa))
a1 = []
for i in l2:
    if i in l26koncowa:  # tu jest chyba błąd
        a1.append(i)
# print('to sa liczby ktore padly ', a1)

c1 = []
for i in l2:
    if i in b1:
        c1.append(i)
print('lczby ktore padły w ostatnim losowaniu ale nie wypadły w ostatnich pięciu losowaniach: ', c1)

###  FRAGMENT DO KOPII ###
l48koncowa = []
for i in l1_17[3:8]:
    for j in i:
        if j not in l48koncowa:
            l48koncowa.append(j)
# print(l37koncowa)
b2 = []
for i in l0:
    if i not in l48koncowa:
        b2.append(i)
# print('lista liczb ktore nie wystapily w ostatnich pieciu losowaniach: ',b2)
print('liczba elementow w padly_w_5_losowaniach', len(l48koncowa))
a2 = []
for i in l3:
    if i in l48koncowa:
        a2.append(i)
# print('to sa liczby ktore padly ', a2)

c2 = []
for i in l3:
    if i in b2:
        c2.append(i)
print('lczby ktore padły w ostatnim losowaniu ale nie wypadły w ostatnich pięciu losowaniach: ', c2)
###  FRAGMENT DO KOPII ###
l59koncowa = []
for i in l1_17[4:9]:
    for j in i:
        if j not in l59koncowa:
            l59koncowa.append(j)
# print(l37koncowa)
b3 = []
for i in l0:
    if i not in l59koncowa:
        b3.append(i)
# print('lista liczb ktore nie wystapily w ostatnich pieciu losowaniach: ',b3)
print('liczba elementow w padly_w_5_losowaniach', len(l59koncowa))
a3 = []
for i in l4:
    if i in l59koncowa:
        a3.append(i)
...
for i in l4:
    if i in b3:
        c3.append(i)
print('lczby ktore padły w ostatnim losowaniu ale nie wypadły w ostatnich pięciu losowaniach: ', c3)

###  FRAGMENT DO KOPII ###
l610koncowa = []
for i in l1_17[5:10]:
    for j in i:
        if j not in l610koncowa:
            l610koncowa.append(j)
# print(l37koncowa)
b4 = []
for i in l0:
    if i not in l610koncowa:
        b4.append(i)
# print('lista liczb ktore nie wystapily w ostatnich pieciu losowaniach: ',b3)
print('liczba elementow w padly_w_5_losowaniach', len(l610koncowa))
a4 = []
for i in l5:
    if i in l610koncowa:
        a4.append(i)
...
for i in l5:
    if i in b4:
        c4.append(i)
print('lczby ktore padły w ostatnim losowaniu ale nie wypadły w ostatnich pięciu losowaniach: ', c4)
